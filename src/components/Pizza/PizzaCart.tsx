...
const PizzaCart: FC<IPizza> = ({ count, imageUrl, price, sizes, title, types, id }) => {
    ...
    return (
        <div className='flex sm:items-center sm:justify-between flex-col sm:flex-row space-y-5 sm:space-y-0'>
            <div className='flex items-center gap-5'>
                ...
                <div className='flex flex-col itens-center'>
                    ...
                    <p className='text-gray-500 text-base sm:text-lg'>{types} тесто, {sizes} см</p>
                </div>
            </div>

            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-4 sm:gap-2 sm:mr-2 mr-0'>
                    ...
                    <p className='font-bold sm:text-base md:text-xl'>{count}</p>
                    ...
                    <p className='font-bold sm:text-base md:text-xl'>{price * count} ₽</p>
                </div>
